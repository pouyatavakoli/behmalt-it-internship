...
* **Certifications**: MikroTik-related certifications such as **MTCNA** and **MTCRE**, along with broader networking certifications such as **CCNA** and **Network+**, are relevant educational paths in networking. For more information, see [Network Certifications](/behmalt-it-internship/appendix/references/).
...
* [Servers and Server Room](/behmalt-it-internship/it-environment/servers-server-room/) — Windows Server can provide services such as DHCP and DNS, while Active Directory enables centralized user and access management.

* [Hardware](/behmalt-it-internship/it-environment/hardware/) — Rack equipment, cable-management tools, and testing equipment used in passive networking.

* [Security](/behmalt-it-internship/it-environment/security/) — Firewall/UTM technologies, including Fortinet / FortiGate, pfSense, and Kerio, as well as physical security for server rooms and network equipment.
