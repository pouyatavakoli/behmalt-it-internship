...
title: Maintenance
description: IT infrastructure maintenance tasks and procedures observed during the internship.
-----------------------------------------------------------------------------------------------
...
* **Periodic Server Maintenance and Repair:** Checking disks and RAID status, fans and other hardware components, monitoring storage capacity and virtual machine status, reviewing logs and service health, and performing preventive maintenance to reduce the risk of failures.
